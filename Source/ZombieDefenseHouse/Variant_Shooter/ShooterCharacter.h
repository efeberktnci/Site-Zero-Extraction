 ...
 */
UCLASS(abstract)
class ZOMBIEDEFENSEHOUSE_API AShooterCharacter : public AZombieDefenseHouseCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
protected:
	...
	/** Sprinting speed while Left Shift is held */
	UPROPERTY(EditAnywhere, Category="Movement", meta = (ClampMin = 0, ClampMax = 3000, Units = "cm/s"))
	...
	/** Weapons granted automatically when this character spawns */
	UPROPERTY(EditAnywhere, Category="Weapons")
...
public:
	...
	/** Equips the first default weapon slot */
	UFUNCTION(BlueprintCallable, Category="Input")
	void DoEquipWeaponSlot1();

	/** Equips the second default weapon slot */
	UFUNCTION(BlueprintCallable, Category="Input")
	void DoEquipWeaponSlot2();

	/** Starts sprinting while held */
	UFUNCTION(BlueprintCallable, Category="Input")
	void DoStartSprint();
...
protected:
	...
	/** Equips a weapon by owned inventory index */
