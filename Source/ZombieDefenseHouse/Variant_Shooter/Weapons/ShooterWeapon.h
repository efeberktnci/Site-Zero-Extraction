 ...
 */
UCLASS(abstract)
class ZOMBIEDEFENSEHOUSE_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
	...
	/** Optional first person static mesh overlay for imported prop weapons */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="Components", meta = (AllowPrivateAccess = "true"))
	UStaticMeshComponent* FirstPersonStaticMesh;

	/** Optional third person static mesh overlay for imported prop weapons */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="Components", meta = (AllowPrivateAccess = "true"))
	UStaticMeshComponent* ThirdPersonStaticMesh;
...
public:
	...
	/** Returns the optional first person static mesh */
	UFUNCTION(BlueprintPure, Category="Weapon")
	UStaticMeshComponent* GetFirstPersonStaticMesh() const { return FirstPersonStaticMesh; };

	/** Returns the optional third person static mesh */
	UFUNCTION(BlueprintPure, Category="Weapon")
	UStaticMeshComponent* GetThirdPersonStaticMesh() const { return ThirdPersonStaticMesh; };
